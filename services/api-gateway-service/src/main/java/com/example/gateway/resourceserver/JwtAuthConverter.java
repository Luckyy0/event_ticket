...
/**
 * Reusable JWT Authentication Converter for downstream Spring Boot Resource Servers.
 * Extracts:
 * 1. Standard OAuth2 scopes (SCOPE_...)
 * 2. Keycloak Realm Roles (ROLE_...)
 * 3. Keycloak Client/Resource Roles (ROLE_...)
 */
@Component
